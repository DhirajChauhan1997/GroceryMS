		...
		<div class="col-12">
			<div class="card">
				<div class="card-body">
					...
					<a href="<?php echo base_url() . "index.php/CreateNewAddressType"; ?>" id="addRow" class="btn btn-primary mb-2"><i class="fas fa-plus"></i>&nbsp; Add New Users Role</a>
							...
							<table id="file_export" class="table table-striped table-bordered display">
								...
								<tbody>
									<?php
										...
										<tr>
											<td><?php echo $row['address_type_id']; ?></td>
											<td><?php echo $row['address_type']; ?></td>

											<td>
												<a href="<?php echo site_url('AddressTypeController/view/' . $row['address_type_id']); ?>" class="btn btn-primary">view</a>
												<a href="<?php echo site_url('AddressTypeController/edit/' . $row['address_type_id']); ?>" class="btn btn-warning">edit</a>
												<a href="<?php echo site_url('AddressTypeController/delete/' . $row['address_type_id']); ?>" class="btn btn-danger" onclick="return confirm('Are you sure to delete?')">delete</a>
											</td>
										</tr>
									<?php
										}
