		...
		<div class="col-12">
			<div class="card">
				<div class="card-body">
					...
					<a href="<?php echo base_url() . "index.php/CreateNewWeightUnit"; ?>" id="addRow" class="btn btn-primary mb-2"><i class="fas fa-plus"></i>&nbsp; Add NewUnit</a>
							...
							<table id="file_export" class="table table-striped table-bordered display">
								...
								<tbody>
									<?php
										...
										<tr>
											<td><?php echo $row['weight_unit_id']; ?></td>
											<td><?php echo $row['unit']; ?></td>

											<td>
												<a href="<?php echo site_url('WeightUnitController/view/' . $row['weight_unit_id']); ?>" class="btn btn-primary">view</a>
												<a href="<?php echo site_url('WeightUnitController/edit/' . $row['weight_unit_id']); ?>" class="btn btn-warning">edit</a>
												<a href="<?php echo site_url('WeightUnitController/delete/' . $row['weight_unit_id']); ?>" class="btn btn-danger" onclick="return confirm('Are you sure to delete?')">delete</a>
											</td>
										</tr>
									<?php
										}
