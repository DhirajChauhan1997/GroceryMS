					...
					<div class="col-sm-12 col-xs-12">
						<form method="POST">
							...
							<div class="form-group">
								...
								<input type="text" name="state_name" value="<?php echo !empty($member['state_name']) ? $member['state_name'] : ''; ?>" class="form-control" id="exampleInputEmail111" placeholder="Enter Username">
							</div>

							<input type="submit" name="formSubmit" class="btn btn-success m-r-10" value="Submit"></input>
							<a href="<?php echo base_url() . "index.php/StateController/index"; ?>" class="btn btn-dark">Cancel</a>
						</form>
					</div>
				</div>
			</div>
