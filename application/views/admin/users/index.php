		...
		<div class="col-12">
			<div class="card">
				<div class="card-body">
					...
					<a href="<?php echo base_url() . "index.php/CreateNewUser"; ?>" id="addRow" class="btn btn-primary mb-2"><i class="fas fa-plus"></i>&nbsp; Add New Users</a>
								...
								<tbody>
									<?php
										...
										<tr>
											...
											<td>
												<a href="<?php echo site_url('UsersController/view/' . $row['userid']); ?>" class="btn btn-primary">view</a>
												<a href="<?php echo site_url('UsersController/edit/' . $row['userid']); ?>" class="btn btn-warning">edit</a>
												<a href="<?php echo site_url('UsersController/delete/' . $row['userid']); ?>" class="btn btn-danger" onclick="return confirm('Are you sure to delete?')">delete</a>
											</td>
										</tr>
									<?php
										}
