		...
		<div class="col-12">
			<div class="card">
				<div class="card-body">
					...
					<a href="<?php echo base_url() . "index.php/CreateNewUserRole"; ?>" id="addRow" class="btn btn-primary mb-2"><i class="fas fa-plus"></i>&nbsp; Add New Users Role</a>
								...
								<tbody>
									<?php
										...
										<tr>
											...
											<td>
												<a href="<?php echo site_url('RoleController/view/' . $row['role_id']); ?>" class="btn btn-primary">view</a>
												<a href="<?php echo site_url('RoleController/edit/' . $row['role_id']); ?>" class="btn btn-warning">edit</a>
												<a href="<?php echo site_url('RoleController/delete/' . $row['role_id']); ?>" class="btn btn-danger" onclick="return confirm('Are you sure to delete?')">delete</a>
											</td>
										</tr>
									<?php
										}
