		...
		<div class="col-12">
			<div class="card">
				<div class="card-body">
					...
					<a href="<?php echo base_url() . "index.php/CreateNewCity"; ?>" id="addRow" class="btn btn-primary mb-2"><i class="fas fa-plus"></i>&nbsp; Add New Users Role</a>
								...
								<tbody>
									<?php
										...
										<tr>
											...
											<td>
												<a href="<?php echo site_url('CityController/view/' . $row['city_id']); ?>" class="btn btn-primary">view</a>
												<a href="<?php echo site_url('CityController/edit/' . $row['city_id']); ?>" class="btn btn-warning">edit</a>
												<a href="<?php echo site_url('CityController/delete/' . $row['city_id']); ?>" class="btn btn-danger" onclick="return confirm('Are you sure to delete?')">delete</a>
											</td>
										</tr>
									<?php
										}
