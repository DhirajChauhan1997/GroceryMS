		...
		<div class="col-12">
			<div class="card">
				<div class="card-body">
					...
					<h6 class="card-subtitle">Manage Users</a></h6>
					<a href="<?php echo base_url() . "index.php/CreateNewSubCategory"; ?>" id="addRow" class="btn btn-primary mb-2"><i class="fas fa-plus"></i>&nbsp; Add New Category</a>
								...
								<tbody>
									<?php
										...
										<tr>
											...
											<td>
												<a href="<?php echo site_url('SubCategoryController/view/' . $row['sub_cat_id']); ?>" class="btn btn-primary">view</a>
												<a href="<?php echo site_url('SubCategoryController/edit/' . $row['sub_cat_id']); ?>" class="btn btn-warning">edit</a>
												<a href="<?php echo site_url('SubCategoryController/delete/' . $row['sub_cat_id']); ?>" class="btn btn-danger" onclick="return confirm('Are you sure to delete?')">delete</a>
											</td>
										</tr>
									<?php
										}
