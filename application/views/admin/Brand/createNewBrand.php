			...
			<div class="card">
				...
				<div class="form-body">
							...
							<div class="row p-t-20">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<img hight="100" width="100" name="cat logo" src="<?php if (!empty($member['brand_logo'])) {
																								echo 'http://localhost:8888/GroceryMS/uploads/BrandImage/' . $member['brand_logo'];
																							} ?>" />
					...
					<div class="form-actions">
						<div class="card-body">
							<input type="submit" name="formSubmit" class="btn btn-success" value="Save"> </input>
