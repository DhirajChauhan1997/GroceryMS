	...
	<footer class="footer text-center">
		All Rights Reserved by Dhiraj And Yogesh . Designed and Developed by <a href="https://templatespoint.net/">TemplatesPoint</a>.
	</footer>
	<!-- ============================================================== -->
	<!-- End footer -->
	<!-- ============================================================== -->
	...
	<!--chartjs -->
	<script src="<?php echo base_url(); ?>assets/libs/chart.js/dist/Chart.min.html"></script>
	...
	<!-- <script type="text/javascript" src="<?php //echo base_url() . 'assets/dist/js/jquery-3.3.1.js' 
												?>"></script> -->
	<!-- <script type="text/javascript" src="<?php //echo base_url() . 'assets/dist/js/bootstrap.js' 
												?>"></script> -->
